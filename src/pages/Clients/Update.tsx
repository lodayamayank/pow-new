...
function Update() {
        ...
        async function loadRecord(uuid: string) {
          try {
            ...
            if(response){
                ...
                formik.initialValues.mobile = response.mobile
                initialValues.email = response.email
                initialValues.pan = response.pan
                initialValues.dob = response.dob
                initialValues.nomineeName = response.nomineeName
                initialValues.description = response.description
                initialValues.is_active = response.is_active
                initialValues.weeklyReport = response.weeklyReport
                ...
                formik.setFieldValue('weeklyReport', response.weeklyReport)
                setData(response)
            }
            setIsLoading(false)
          } catch (error) {
    ...
    const breadCrumbs = [
        ...
        {title: `Update Client Details: ${data ? data.name : ''}`, path: '', isActive: true}
    ]
                                                ...
                                                <div className="card">
                                                    <div className="card-header">
                                                        <h3 className="card-title">
                                                            Update Client Details: {data ? data.name : ''}
