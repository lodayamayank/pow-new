...
import { Client, ClientAdjustments, clientAdjustmentsDetailsInitValues as initialValues } from "../../core/_models";
import { createClientAdjustmentsRecord, getRecordById as getClientRecordById } from "../../core/_requests";
...
export function Create(props: Props) {
    ...
    const formik = useFormik<ClientAdjustments>({
        ...
        try {
            ...
            const respData = await createClientAdjustmentsRecord(clientId,values)
            setIsLoading(false)
