...
import { Client, ClientAUM, clientAUMDetailsInitValues as initialValues } from "../../core/_models";
import { createClientAUMRecord, getRecordById as getClientRecordById } from "../../core/_requests";
...
export function Create(props: Props) {
    ...
    const formik = useFormik<ClientAUM>({
        ...
        try {
            ...
            const respData = await createClientAUMRecord(clientId,values)
            setIsLoading(false)
        ...
        <div className="row row-cards">
            ...
            <form onSubmit={formik.handleSubmit} className='card border-0' autoComplete="none">
                    <div className="card-header">
                        <h3 className="card-title">Add Client AUM</h3>
