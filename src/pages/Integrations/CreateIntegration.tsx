...
function CreateIntegration() {
    ...
    const { INTEGRATIONS_PATH } = useRoutePaths()
                                        ...
                                        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                                    <Breadcrumbs links={[{title: 'Integrations', path: INTEGRATIONS_PATH, isActive: false},{ title: 'Create New Integration', path: '', isActive: true}]} />
                                                </p>
                                            </div>

                                            <div>
                                                <div className="mt-6 flex items-center justify-end gap-x-6">
                                                <a href={INTEGRATIONS_PATH} className="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
                                                <button 
                                                    type='submit' 
