...
function UpdateService() {
    ...
    const { SERVICES_UPDATE_PATH, SERVICES_PATH } = useRoutePaths()
                                ...
                                <div className="bg-white shadow border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                                    <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                <Breadcrumbs links={[{title: 'Services', path: SERVICES_PATH, isActive: false},{ title: 'Update Service ('+data.name+')', path: '', isActive: true}]} />
                                            </p>
                                        </div>
                                    ...
                                    <div className="space-y-12">
                                        <Tabs style="fullWidth">
                                            <Tabs.Item active title="Serivce Details">
                                            ...
                                            <Tabs.Item title="Permissions List">
                                                <ServicePermissions service={data} />
                                            </Tabs.Item>
                                        </Tabs>
                                    </div>
                                </div>
