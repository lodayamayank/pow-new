...
import { asset_url, matchCurrentRoute } from '@/utils'
...
function NavBar() {
  ...
  const navigation = [
      { name: 'Dashboard', href: '/', current: matchCurrentRoute(['/']) },
      { name: 'Users', href: '/users', current: matchCurrentRoute(['/users','/users/create']), permissions: ['view_users'] },
      { name: 'Roles & Permissions', href: '/roles', current: matchCurrentRoute(['/roles']) , permissions: ['view_roles'] },
      { name: 'Services', href: '/services', current: matchCurrentRoute(['/services']), permissions: ['view_services'] },
      { name: 'Integrations', href: '/integrations', current: matchCurrentRoute(['/integrations']), permissions: ['view_integrations'] },
  ]
                        ...
                        <Menu.Button className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                          ...
                          { user ? (
                            <div className="relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 rounded-full dark:bg-gray-600">
                              <span className="font-bold text-gray-600 dark:text-gray-300">{user?.name[0].toUpperCase()+user?.name[1].toUpperCase()}</span>
                            </div>
                          ) : (
